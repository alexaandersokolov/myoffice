...
class MyofficePageLocators:
    ...
    BUTTON_BUY = (By.XPATH, "//a[@class=' included-main__list-btn']")
    FIELD_COMPANY_NAME = (By.XPATH, "//input[@placeholder='Название компании']")
    REGION = (By.XPATH, "//span[@class='selected']")
    REGION_RUSSIA = (By.XPATH, "//span[@class='selectOption'][contains(text(),'Вся Россия')]")
    CHECKBOX_PROFESSIONAL = (By.XPATH, "//span[contains(text(),'МойОфис Профессиональный 2')]")
    BUTTON_SEARCH = (By.XPATH, "//button[contains(text(),'Поиск')]")